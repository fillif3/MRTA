...
public class TestMissionDispatch1 {
...
//		final TrajectoryEnvelopeCoordinatorSimulation tec = new TrajectoryEnvelopeCoordinatorSimulation(MAX_VEL,MAX_ACCEL);
		...
		Coordinate footprint1 = new Coordinate(-5,-5);
		Coordinate footprint2 = new Coordinate(5,-5);
		Coordinate footprint3 = new Coordinate(5,5);
		Coordinate footprint4 = new Coordinate(-5,5);
		...
		tec.placeRobot(1, Missions.getLocation("P_2"));
		
		Missions.enqueueMission(new Mission(1, Missions.getShortestPath("P_2","loc_2")));		
